resource "aws_glue_catalog_table" "config_logs" {
  ...
  parameters = {
    ...
    "storage.location.template"   = "s3://${var.system_logs_bucket}/Config/AWSLogs/${var.aws_account_id}/Config/ap-northeast-1/$${dt}/ConfigHistory/"
  }

  storage_descriptor {
    location      = "s3://${var.system_logs_bucket}/Config/AWSLogs/${var.aws_account_id}/Config/ap-northeast-1"
