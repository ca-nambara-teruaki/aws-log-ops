...
resource "aws_s3_bucket" "athena" {
  bucket              = "${var.aws_account_id}-${var.env_name}-${var.sys_name}-athena"
  object_lock_enabled = true

  force_destroy = true
}

resource "aws_s3_bucket_server_side_encryption_configuration" "server_access_athena" {
...
resource "aws_s3_bucket_public_access_block" "athena_conf" {
